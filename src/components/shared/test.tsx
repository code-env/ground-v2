export default function Test() {
  return (
    <footer className="before:bg-[linear-gradient(to_right,whitesmoke,hsl(var(--border))_200px,hsl(var(--border))_calc(100%-200px),whitesmoke)] relative mt-16 py-8 before:absolute before:-inset-x-32 before:top-0 before:h-px">
      <div
